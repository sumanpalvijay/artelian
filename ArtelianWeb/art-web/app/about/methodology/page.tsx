        ...
        <div className="font-serif">
            ...
            <section className="bg-[#d8cfc2] px-6 sm:px-16 py-20">
                <div className="grid md:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
                    ...
                    {/* LEFT TEXT */}
                    <div>
                        <h2 className="text-3xl text-[#8a4b32] mb-6">Methodology</h2>

                        <p className="text-[18px] leading-loose text-gray-800">
                            The methodology of Artelia Institute of Arts is to provide the
            ...
            <section className="bg-[#d8cfc2] px-6 sm:px-16 py-20">
                <div className="grid md:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
                    ...
                    {/* LEFT TEXT */}
                    <div>
                        <h2 className="text-3xl text-[#8a4b32] mb-6">Varied Approaches</h2>
